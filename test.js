!(function(t) {
  ...
  function(t, e, r) {
    ...
    function n(t, e) {
      ...
      i(this.client.notifier),
        ...
        (this.options.captureUncaught ||
          ...
          (f.captureUncaughtExceptions(n, this), f.wrapGlobals(n, this)),
        (this.options.captureUnhandledRejections ||
          this.options.handleUnhandledRejections) &&
          f.captureUnhandledRejections(n, this),
        (this.instrumenter = new w(
          this.options,
    ...
    (n.init = function(t, e) {
      ...
      (n.prototype.handleUnhandledRejection = function(t, e) {
        ...
        c.isError(t)
          ? (n = this._createItem([r, t, o]))
          : ((n = this._createItem([r, t, o])),
            (n.stackInfo = c.makeUnhandledStackInfo(
              r,
              '',
              0,
              0,
          ...
          (n.level = this.options.uncaughtErrorLevel),
          (n._isUncaught = !0),
          (n._originalArgs = n._originalArgs || []),
          n._originalArgs.push(e),
          this.client.log(n);
      }),
  ...
  function(t, e, r) {
    'use strict';
    function n(t, e, r, o) {
      (this.options = c.merge(t)),
        (this.logger = r),
        n.rateLimiter.configureGlobal(this.options),
        n.rateLimiter.setPlatformOptions(o, this.options),
        (this.queue = new a(n.rateLimiter, e, r, this.options)),
        (this.notifier = new s(this.queue, this.options)),
        (this.telemeter = new u(this.options)),
        (this.lastError = null),
    ...
    var i = r(3),
      ...
      u = r(9),
      c = r(5),
      l = { maxItems: 0, itemsPerMinute: 60 };
    (n.rateLimiter = new i(l)),
      (n.prototype.global = function(t) {
        return n.rateLimiter.configureGlobal(t), this;
      }),
      (n.prototype.configure = function(t, e) {
        this.notifier && this.notifier.configure(t),
          this.telemeter && this.telemeter.configure(t);
        var r = this.options,
          n = {};
        return (
          e && (n = { payload: e }),
  ...
  function(t, e) {
    ...
    function o(t, e, r, n, o, a, s) {
      ...
      return (
        r && (r = new Error(r)),
        r || n || (u = i(t, e, o, a, s)),
        { error: r, shouldSend: n, payload: u }
      );
    }
    ...
    (r.globalSettings = {
      ...
      (r.prototype.shouldSend = function(t, e) {
        ...
        if (n(t, a, this.perMinCounter))
          return o(
            this.platform,
            this.platformOptions,
            a + ' items per minute reached',
            !1
          );
    ...
    (n.prototype.configure = function(t) {
      ...
      (n.prototype._applyPredicates = function(t) {
        for (var e = null, r = 0, n = this.predicates.length; r < n; r++)
          if (
            ((e = this.predicates[r](t, this.options)), !e || void 0 !== e.err)
          )
    ...
    (n.prototype._maybeRetry = function(t, e, r) {
      ...
      (n.prototype._maybeLog = function(t, e) {
        if (this.logger && this.options.verbose) {
          var r = e;
          if (
            ((r = r || o.get(t, 'body.trace.exception.message')),
            (r = r || o.get(t, 'body.trace_chain.0.exception.message')))
          )
    ...
    function I(t, e, r) {
      if (t) {
        ...
        if (!(o < 1)) {
          ...
          try {
            for (var i = t[n[0]] || {}, a = i, s = 1; s < o - 1; s++)
              (i[n[s]] = i[n[s]] || {}), (i = i[n[s]]);
            (i[n[o - 1]] = r), (t[n[0]] = a);
          } catch (t) {
            return;
      ...
      if (t && t.user_ip && e !== !0) {
        ...
        if (e)
          try {
            var n;
            if (r.indexOf('.') !== -1)
              (n = r.split('.')), n.pop(), n.push('0'), (r = n.join('.'));
            else if (r.indexOf(':') !== -1) {
          ...
          (t.parse = (function() {
            ...
            var e,
              ...
              c = {
                '{': {
                  go: function() {
                    r.push({ state: 'ok' }), (n = {}), (e = 'firstokey');
                  },
                  ovalue: function() {
                    r.push({ container: n, state: 'ocomma', key: o }),
                      (n = {}),
                      (e = 'firstokey');
                  },
                  firstavalue: function() {
                    r.push({ container: n, state: 'acomma' }),
                      (n = {}),
                      (e = 'firstokey');
                  },
                  avalue: function() {
                ...
                '[': {
                  go: function() {
                    r.push({ state: 'ok' }), (n = []), (e = 'firstavalue');
                  },
                  ovalue: function() {
                    r.push({ container: n, state: 'ocomma', key: o }),
                      (n = []),
  ...
  function(t, e, r) {
    ...
    (n.prototype.configure = function(t) {
      ...
      (n.prototype.log = function(t, e) {
        if (
          ((e && o.isFunction(e)) || (e = function() {}), !this.options.enabled)
        )
        ...
        this._applyTransforms(
          ...
          function(n, o) {
            return n
              ? (this.queue.removePendingItem(t), e(n, null))
              : void this.queue.addItem(o, e, r, t);
          }.bind(this)
        );
      }),
      (n.prototype._applyTransforms = function(t, e) {
        var r = -1,
          ...
          a = function(t, s) {
            return t
              ? void e(t, null)
              : (r++, r === n ? void e(null, s) : void o[r](s, i, a));
          };
        a(null, t);
      }),
      (t.exports = n);
  ...
  function(t, e, r) {
    ...
    (n.prototype.configure = function(t) {
      ...
      var r = this.options.maxTelemetryEvents || a,
        ...
        o = 0;
      this.maxQueueSize > n && (o = this.maxQueueSize - n),
        (this.maxQueueSize = n),
      ...
      (n.prototype.capture = function(t, e, r, n, a) {
        ...
        try {
          if (
            i.isFunction(this.options.filterTelemetry) &&
  ...
  function(t, e, r) {
    ...
    function i(t, e) {
      ...
      return (
        ...
        { protocol: r, hostname: o, path: i, port: n, method: e }
      );
    }
    function a(t, e) {
      var r = /\/$/.test(t),
  ...
  function(t, e, r) {
    ...
    function o() {
      ...
      t.unshift('Rollbar:'),
        a.ieVersion() <= 8
          ? console.info(s.formatArgsAsString(t))
    ...
    function i() {
      ...
      t.unshift('Rollbar:'),
        a.ieVersion() <= 8
          ? console.log(s.formatArgsAsString(t))
          : console.log.apply(console, t);
    }
    r(13);
    var a = r(14),
      s = r(5);
    t.exports = { error: n, info: o, log: i };
  },
  function(t, e) {
    !(function(t) {
      'use strict';
    ...
    function r() {
      ...
      for (
        var e = 3,
          ...
          n = r.getElementsByTagName('i');
        (r.innerHTML = '<!--[if gt IE ' + ++e + ']><i></i><![endif]-->'), n[0];
    ...
    function r(t, e, r) {
      if (t) {
        ...
        'function' == typeof e._rollbarOldOnError
          ...
          : t.onerror &&
            !t.onerror.belongsToShim &&
            ((o = t.onerror), (e._rollbarOldOnError = o));
        var i = function() {
      ...
      if (t) {
        ...
        var n = function(t) {
          ...
          r || (r = '[unhandledrejection] error getting `reason` from event'),
            e && e.handleUnhandledRejection && e.handleUnhandledRejection(r, n);
        };
        (n.belongsToShim = r),
          (t._rollbarURH = n),
    ...
    function i(t, e, r) {
      if (t) {
        ...
        for (n = 0; n < i.length; ++n)
          (o = i[n]), t[o] && t[o].prototype && a(e, t[o].prototype, r);
      }
    }
    function a(t, e, r) {
  ...
  function(t, e, r) {
    ...
    function n(t, e, r, n, o) {
      (n && l.isFunction(n)) || (n = function() {}),
        l.addParamsAndAccessTokenToPath(t, e, r);
      var a = 'GET',
        s = l.formatUrl(e);
      i(t, s, a, null, n, o);
    }
    function o(t, e, r, n, o) {
      if (((n && l.isFunction(n)) || (n = function() {}), !r))
        ...
        try {
          ...
          p.open(r, e, !0),
            p.setRequestHeader &&
              ...
              p.setRequestHeader('X-Rollbar-Access-Token', t)),
    ...
    function u(t) {
      return (
        t && l.isType(t.status, 'number') && t.status >= 400 && t.status < 600
      );
    }
    function c(t, e) {
      var r = new Error(t);
  ...
  function(t, e, r) {
    ...
    function i(t, e, r) {
      ...
      var n,
        i = t.data.body;
      if (i.trace_chain)
        for (var a = i.trace_chain, s = 0; s < a.length; s++)
          (n = a[s].frames), (n = o(n, r)), (a[s].frames = n);
      else
        i.trace && ((n = i.trace.frames), (n = o(n, r)), (i.trace.frames = n));
      return [t, f.stringify(t, e)];
    }
    function a(t, e) {
    ...
    function u(t) {
      return (
        t.exception &&
          ...
          (t.exception.message = a(255, t.exception.message))),
        (t.frames = o(t.frames, 1)),
        t
      );
    }
    function c(t, e) {
    ...
    function p(t, e, r) {
      ...
      for (
        ...
        if (((a = o(t, e)), (t = a[0]), (u = a[1]), u.error || !l(u.value, r)))
          return u;
      return u;
    }
    var f = r(5);
  ...
  function(t, e) {
    ...
    function r(t) {
      ...
      if (
        ((e = t.indexOf('//')),
        e !== -1 ? ((n.protocol = t.substring(0, e)), (r = e + 2)) : (r = 0),
        (e = t.indexOf('@', r)),
        e !== -1 && ((n.auth = t.substring(r, e)), (r = e + 1)),
        (e = t.indexOf('/', r)),
        e === -1)
      ) {
        if (((e = t.indexOf('?', r)), e === -1))
          return (
            (e = t.indexOf('#', r)),
            e === -1
  ...
  function(t, e, r) {
    ...
    function n(t, e, r) {
      if (((t.data = t.data || {}), t.err))
        try {
          ...
          try {
            t.message =
              t.err.message || t.err.description || t.message || String(t.err);
          } catch (e) {
    ...
    function a(t) {
      return function(e, r, n) {
        ...
        var o = '$remote_ip';
        r.captureIp ? r.captureIp !== !0 && (o += '_anonymize') : (o = null),
    ...
    function u(t) {
      return function(e, r, n) {
        ...
        for (
          var o, i = [], a = t.navigator.plugins || [], s = 0, u = a.length;
          s < u;
          ++s
        )
    ...
    function p(t, e, r) {
      ...
      if (
        ...
        0 === p.length &&
          ((c.exception.stack = o.rawStack),
          (c.exception.raw = String(o.rawException)));
        var f, m, g, v, y, b, w, _;
        for (c.frames = [], w = 0; w < p.length; ++w)
          (f = p[w]),
            ...
            (m.method &&
              m.method.endsWith &&
              m.method.endsWith('_rollbar_wrapped')) ||
              ((g = v = y = null),
      ...
      return {
        ...
        parseOpera10: function(e) {
          for (
            ...
            var s = r.exec(n[i]);
            s &&
              o.push(new t(s[3] || void 0, void 0, s[2], s[1], void 0, n[i]));
          }
          return o;
        },
  ...
  function(t, e, r) {
    ...
    function o(t, e, r) {
      t.telemetryEvents && u.set(t, 'data.body.telemetry', t.telemetryEvents),
        r(null, t);
    }
    function i(t, e, r) {
      ...
      if ((o || ((n = 'data.body.trace'), (o = u.get(t, n))), o)) {
        if (!o.exception || !o.exception.description)
          return (
            u.set(t, n + '.exception.description', t.message), void r(null, t)
          );
  ...
  function(t, e, r) {
    ...
    function n(t, e) {
      return (
        !o.get(e, 'plugins.jquery.ignoreAjaxErrors') ||
        !o.get(t, 'body.message.extra.isAjax')
      );
    }
    var o = r(5);
    t.exports = { checkIgnore: n };
  },
  function(t, e, r) {
    'use strict';
    function n(t, e) {
    ...
    function s(t, e, r, n) {
      ...
      try {
        ...
        for (l = a.frames.length, d = 0; d < l; d++) {
          if (((s = a.frames[d]), (u = s.filename), !c.isType(u, 'string')))
            return !o;
          for (m = 0; m < f; m++)
    ...
    function u(t) {
      return function(e, r) {
        ...
        try {
          if (((s = !1), (i = r.ignoredMessages), !i || 0 === i.length))
            return !0;
          if (
            ((l = e.body),
          ...
          for (
            a = i.length, o = 0;
            o < a && ((u = new RegExp(i[o], 'gi')), !(s = u.test(n)));
            o++
          );
        } catch (e) {
  ...
  function(t, e, r) {
    ...
    function s(t, e, r, n, o) {
      ...
      t.enabled === !1 || i === !1
        ? (this.autoInstrument = {})
        : (u.isType(i, 'object') || (i = p),
          (this.autoInstrument = u.merge(p, i))),
        (this.scrubTelemetryInputs = !!t.scrubTelemetryInputs),
        (this.telemetryScrubber = t.telemetryScrubber),
        (this.defaultValueScrubber = a(t.scrubFields)),
        (this.telemeter = e),
        (this.rollbar = r),
        (this._window = n || {}),
        (this._document = o || {}),
    ...
    (s.prototype.configure = function(t) {
      ...
      t.enabled === !1 || e === !1
        ? (this.autoInstrument = {})
        : (u.isType(e, 'object') || (e = p),
          (this.autoInstrument = u.merge(p, e))),
        this.instrument(r),
                ...
                return function(o) {
                  function i() {
                    if (
                      ...
                      if (1 === a.readyState)
                        a.__rollbar_xhr.start_time_ms = u.now();
                      else {
                          ...
                          try {
                            ...
                            if (n === !0) {
                              ...
                              for (s = 0; s < n.length; s++)
                                (i = n[s]), (r[i] = a.getResponseHeader(i));
                          } catch (t) {}
                        }
                        var h = null;
                        ...
                        var d = null;
                        (h || r) &&
                          ((d = {}), h && (d.body = h), r && (d.headers = r)),
                          d && (a.__rollbar_xhr.response = d);
                      }
                      try {
                        var m = a.status;
                        (m = 1223 === m ? 204 : m),
                          (a.__rollbar_xhr.status_code = m),
                          (a.__rollbar_event.level = e.telemeter.levelFromStatus(
                            m
                          ));
                      } catch (t) {}
                    }
                  ...
                  return (
                    ...
                    u.isFunction(a.onreadystatechange)
                      ? n(a, 'onreadystatechange', function(t) {
        ...
        'fetch' in this._window &&
          n(
            ...
            function(t) {
              return function(r, n) {
                for (
                  var o = new Array(arguments.length), i = 0, a = o.length;
                  i < a;
                  i++
                )
                  o[i] = arguments[i];
                ...
                return (
                  ...
                  t.apply(this, o).then(function(t) {
                    ...
                    var a = null;
                    return r && (a = { headers: r }), a && (p.response = a), t;
                  })
                );
              };
            },
      ...
      (s.prototype.handleClick = function(t) {
        try {
          var e = l.getElementFromEvent(t, this._document),
            r = e && e.tagName,
            n =
              l.isDescribedElement(e, 'a') || l.isDescribedElement(e, 'button');
          r && (n || l.isDescribedElement(e, 'input', ['button', 'submit']))
            ? this.captureDomEvent('click', e)
            : l.isDescribedElement(e, 'input', ['checkbox', 'radio']) &&
      ...
      (s.prototype.handleBlur = function(t) {
        try {
          ...
          e &&
            e.tagName &&
            (l.isDescribedElement(e, 'textarea')
              ? this.captureDomEvent('input', e, e.value)
              : l.isDescribedElement(e, 'select') &&
                e.options &&
                e.options.length
              ? this.handleSelectInputChanged(e)
              : l.isDescribedElement(e, 'input') &&
                !l.isDescribedElement(e, 'input', [
                  'button',
                  'submit',
                  'hidden',
      ...
      (s.prototype.captureDomEvent = function(t, e, r, n) {
        if (void 0 !== r)
          if (this.scrubTelemetryInputs || 'password' === l.getElementType(e))
            r = '[scrubbed]';
          else {
          ...
          n(
            ...
            function(t) {
              return function() {
                ...
                o.handleUrlChange(o._lastHref, e),
            ...
            n(
              ...
              function(t) {
                return function() {
                  ...
                  return (
                    e && o.handleUrlChange(o._lastHref, e + ''),
                    t.apply(this, arguments)
                  );
                };
              },
      ...
      (s.prototype.removeListeners = function(t) {
        for (var e; this.eventRemovers[t].length; )
          (e = this.eventRemovers[t].shift())();
      }),
      (t.exports = s);
  },
  function(t, e) {
    ...
    function u(t) {
      ...
      for (i.attributes = [], o = 0; o < a.length; o++)
        (r = a[o]),
          (n = t.getAttribute(r)),
          n && i.attributes.push({ key: r, value: n });
      return i;
    }
    t.exports = {
      describeElement: u,
